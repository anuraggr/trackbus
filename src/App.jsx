...
function App() {
  ...
  const handleUserLoc = () => {
    if (!watchId) {
      getUserLocation(); // Start tracking if it's not already
    } else if (userLocation) {
      zoomToUserLocation(); // If already tracking, zoom to user's location
    }
  };
              ...
              >
                ...
                {userLocation && (
                  <Circle
                    ...
                    radius={5}
                    pathOptions={{ color: 'blue', fillColor: 'blue', fillOpacity: 0 }}
                  />
                )}
              </MapContainer>
